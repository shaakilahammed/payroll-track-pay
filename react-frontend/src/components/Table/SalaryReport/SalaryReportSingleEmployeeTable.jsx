...
const SalaryReportSingleEmployeeTable = React.forwardRef(
...
SalaryReportSingleEmployeeTable.propTypes = {
...
SalaryReportSingleEmployeeTable.displayName =
    'Salary Report Single Employee Table';

export default SalaryReportSingleEmployeeTable;
